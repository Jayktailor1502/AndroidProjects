...
public class GetBackStateFlags {
    ...
    public String toString() {
        return "isLocationFound = " + isLocationFound + ", isPhotoCaptured = " + isPhotoCaptured + ", isTheftTriggered = " + isTheftTriggered + ", isEmailSent = " + isEmailSent + ", isSmsSent = " + isSmsSent + ", isDataDeleted = " + isDataDeleted + ", isScreenOn = " + isScreenOn + ", isRcvdCommand_1 = " + isTriggerCommandReceived + ", isNetworkAvailable = " + isNetworkAvailable;
    }
